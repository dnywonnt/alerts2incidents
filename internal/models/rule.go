...
type Rule struct {
	...
	IncidentFinishingInterval        time.Duration   `json:"incident_finishing_interval" validate:"omitempty"`                                                                                                                                // Optional duration after which an incident is considered finished.
